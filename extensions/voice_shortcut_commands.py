...
_EXACT_COMMANDS: dict[str, tuple[Callable[[], Optional[str]], str]] = {
    ...
    "take screenshot": (_screenshot, "Screenshot"),
    "capture screenshot": (_screenshot, "Screenshot"),
    "take a screenshot": (_screenshot, "Screenshot"),
    "capture screen": (_screenshot, "Screenshot"),
    "save screenshot": (_screenshot, "Screenshot"),
    ...
    "move up": (_up, "Move up"),
    "move down": (_down, "Move down"),
    "move left": (_left, "Move left"),
    "move right": (_right, "Move right"),
    "go up": (_up, "Move up"),
    "go down": (_down, "Move down"),
    "arrow up": (_up, "Move up"),
    "arrow down": (_down, "Move down"),
    "press enter": (_enter, "Enter"),
    "press up": (_up, "Move up"),
    "press down": (_down, "Move down"),
    "up": (_up, "Move up"),
    "down": (_down, "Move down"),
    "left": (_left, "Move left"),
    "right": (_right, "Move right"),
    "enter": (_enter, "Enter"),
    "back": (_go_back, "Go back"),
    "next": (_right, "Next"),
    "previous": (_left, "Previous"),
